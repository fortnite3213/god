...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "990E8"
        self.SecretKey: str = "HK94NXO5UEEAX8X9UXHX4HWY4IYH9CY75HBAMOKOK9Z5YUCQYG"
        self.ApiKey: str = "OC|8745077415616900|f9853ee6f8e5bc409b6d8261e06e5303"
...
def title_data():
    response = requests.post(
        url=f"https://244AF.playfabapi.com/Server/GetTitleData",
        headers={
