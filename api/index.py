...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "18F162"
        self.SecretKey : str = "8D4YQCUP1758XSINZICSM7PDPQAN5QJ1TO65169P34P9C4QTQ5"
        self.ApiKey : str = "OC|31096352569963834|557985ae754a8acdbc07aa83c4472d19"
